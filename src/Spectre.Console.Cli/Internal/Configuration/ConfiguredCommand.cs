...
internal sealed class ConfiguredCommand
{
    ...
    public Func<CommandContext, ICommandSettings, Task<int>>? Delegate { get; }
    ...
    private ConfiguredCommand(
        ...
        Type? commandType,
        Type settingsType,
        Func<CommandContext, ICommandSettings, Task<int>>? @delegate,
    ...
    public static ConfiguredCommand FromDelegate<TSettings>(
        string name, Func<CommandContext, ICommandSettings, Task<int>>? @delegate = null)
        where TSettings : ICommandSettings
    {
